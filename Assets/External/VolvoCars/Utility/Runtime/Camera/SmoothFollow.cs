...
public class SmoothFollow : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        float wantedHeight = camYTarget.position.y + targetOffset.y + height + (Mathf.Clamp(elevationFromCar,0, float.MaxValue));
        // print(camYTarget.position.y);
