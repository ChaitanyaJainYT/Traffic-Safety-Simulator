...
// #endif
        ...
        void UpdateColliderBoundingBox()
        {
            foreach (var o in m_objects)
            {
                ...
                // Transform[] collider = o.GetComponentsInChildren<Transform>();
                // // collider[0].transform.position = o.transform.position;
                // collider[1].transform.position = collider[0].transform.parent.transform.position;
                // print(collider[0].transform.parent.transform.position.x + ", " + collider[0].transform.parent.transform.position.y);
